...
class Object3d(object):
    ...
    def __init__(self, label_file_line, isFromSMOKE = False):
        # pdb.set_trace()
        if not isFromSMOKE:
            data = label_file_line.split(" ")
...
def parsingOutput(smokeOutput):
    # lines = [line.rstrip() for line in open(label_filename)]
    objects = [Object3d(obj, True) for obj in smokeOutput]
    return objects
